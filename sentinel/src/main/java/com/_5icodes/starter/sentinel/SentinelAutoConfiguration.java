...
public class SentinelAutoConfiguration {
	...
	private void init() {
		...
		if (!StringUtils.hasText(System.getProperty(LogBase.LOG_NAME_USE_PID))
		...
		if (!StringUtils.hasText(System.getProperty(TransportConfig.HEARTBEAT_INTERVAL_MS))
				&& StringUtils
						.hasText(properties.getTransport().getHeartbeatIntervalMs())) {
			System.setProperty(TransportConfig.HEARTBEAT_INTERVAL_MS,
					properties.getTransport().getHeartbeatIntervalMs());
		}
		if (!StringUtils.hasText(System.getProperty(TransportConfig.HEARTBEAT_CLIENT_IP))
		...
		if (!StringUtils.hasText(System.getProperty(SentinelConfig.CHARSET))
		...
		if (!StringUtils
				.hasText(System.getProperty(SentinelConfig.SINGLE_METRIC_FILE_SIZE))
		...
		if (!StringUtils
				.hasText(System.getProperty(SentinelConfig.TOTAL_METRIC_FILE_COUNT))
		...
		if (!StringUtils.hasText(System.getProperty(SentinelConfig.COLD_FACTOR))
