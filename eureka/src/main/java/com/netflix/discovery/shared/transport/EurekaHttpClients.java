...
import com._5icodes.starter.eureka.client.MultiServerEurekaHttpClient;
import com._5icodes.starter.eureka.client.ZoneAffinityEurekaHttpClient;
        ...
        return new EurekaHttpClientFactory() {
            ...
            public EurekaHttpClient newClient() {
                return new SessionedEurekaHttpClient(
                        name,
                        EurekaClientNames.REGISTRATION.equals(name) ?
                                ZoneAffinityEurekaHttpClient.createFactory(
                                        name,
                                        transportConfig,
                                        clusterResolver,
                                        RedirectingEurekaHttpClient.createFactory(transportClientFactory),
                                        ServerStatusEvaluators.legacyEvaluator()) :
                                EurekaClientNames.QUERY.equals(name) ?
                                        MultiServerEurekaHttpClient.createFactory(
                                                name,
                                                transportConfig,
                                                clusterResolver,
                                                RedirectingEurekaHttpClient.createFactory(transportClientFactory),
