...
/**
 * {@link ZoneAffinityEurekaHttpClient} retries failed requests on subsequent servers in the cluster.
 ...
 */
public class ZoneAffinityEurekaHttpClient extends EurekaHttpClientDecorator {

    private static final Logger logger = LoggerFactory.getLogger(ZoneAffinityEurekaHttpClient.class);
    ...
    public ZoneAffinityEurekaHttpClient(String name,
    ...
    public static EurekaHttpClientFactory createFactory(final String name,
        ...
        return new EurekaHttpClientFactory() {
            ...
            public EurekaHttpClient newClient() {
                return new ZoneAffinityEurekaHttpClient(name, transportConfig, clusterResolver, delegateFactory,
