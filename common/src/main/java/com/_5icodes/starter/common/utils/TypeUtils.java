...
public class TypeUtils {
    private final Type[] EMPTY_TYPE_ARRAY = new Type[0];
    ...
    Type resolve(Type context, Class<?> contextRawType, Type toResolve) {
    ...
    private Type resolveTypeVariable(
            Type context,
     ...
     */
    Type getGenericSupertype(Type context, Class<?> rawType, Class<?> toResolve) {
     ...
     * a class.
     */
    private Class<?> declaringClassOf(TypeVariable<?> typeVariable) {
        GenericDeclaration genericDeclaration = typeVariable.getGenericDeclaration();
        return genericDeclaration instanceof Class ? (Class<?>) genericDeclaration : null;
    }

    private final class GenericArrayTypeImpl implements GenericArrayType {
