...
public class CacheMetricNode {
    ...
    public CacheMetricNode setClassification(int classification) {
    ...
    public CacheMetricNode setConcurrency(int concurrency) {
    ...
    /**
     * Parse {@link CacheMetricNode} from thin string, see {@link #toThinString()}
     *
     * @param line
     * @return
     */
    public static CacheMetricNode fromThinString(String line) {
    ...
    /**
     * To formatting string. All "|" in {@link CacheMetricNode#resource} will be
    ...
    /**
     * Parse {@link CacheMetricNode} from fat string, see {@link #toFatString()}
     *
     * @param line
     * @return the {@link CacheMetricNode} parsed.
     */
    public static CacheMetricNode fromFatString(String line) {
        String[] strs = line.split("\\|");
